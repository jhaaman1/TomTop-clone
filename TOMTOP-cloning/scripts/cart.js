...
let total = cart.reduce(function (sum, el, index, arr) {

    return sum + Number(Math.floor(el.price))
...
document.querySelector("#p").innerText = ` Total no of Items :  ${length} `;
...
cart.map(function (el, index) {
    ...
    tcol6.innerText = "Standard Delivery By 08 july - 10 july "
